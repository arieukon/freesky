package com.kulomady.freesky.view.viewComponent;
...
public class ProductContextMenuManager extends RecyclerView.OnScrollListener implements View.OnAttachStateChangeListener {

    private static ProductContextMenuManager instance;
    ...
    public static ProductContextMenuManager getInstance() {
        if (instance == null) {
            instance = new ProductContextMenuManager();
        }
        return instance;
    }

    private ProductContextMenuManager() {
